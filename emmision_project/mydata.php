...
<head>
    ...
    <link href="css/styles-mydata.css" rel="stylesheet">
...
<body>
  ...
  <div class="box" id="input-data">
        <h3>
          <div id="c-name" class="company-info">
            Company Name
          </div>
        </h3>
      </div>
      <div class="box">
        <h2 class="">Your Data for the year</h2>
        <div class="num-counter" style="padding-bottom: 20px;">
            <input
              type="number"
              name="year"
              id="num-year"
          ...
          <form>
          <div>
            <input type="button" class="btn" onclick="changeYear()" value="Submit">
          </div>
        </form>
          <script>
            const d = new Date();
            let year = d.getFullYear();
            document.getElementById("num-year").value= year;
            </script>
      ...
      <div class="box" id="input-data">
        <section class="carbon-info">
          <div class="container">
              ...
              <p id="year-edited"></p>
              <p><strong>Carbon Emissions:</strong> <input type="number" value="1000" id="e-point" size="4" max="1500" disabled style="width:60px;">  tons</p> 
              <p><strong>Carbon Credits Available:</strong> <span><input type="number" value="1500" id="e-point1" size="4" max="1500" disabled style="width:60px;"> tons</span></p>
          </div>
  ...
  function highlightStars(value) {
    ratingStars.forEach((star) => {
      ...
      function changeYear()
      {
        let p=document.getElementById("year-edited");
         let x=document.getElementById("num-year").value;
        p.innerHTML="<strong>Year : </strong>"+x;
        r=document.getElementById("e-point").value;
        r1=document.getElementById("e-point1");
        r1.value=1500-r;
        r=1500-r;
        r/=300;
        r++;
